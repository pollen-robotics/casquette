...
# Default I2C addresses for the BMI088 wired on top of the Grabette/Casquette
# HAT stack. SDO0 strapped high → accel at 0x19; SDO2 strapped high → gyro
# at 0x69. The default-low gyro address (0x68) collides with the PiSugar
# battery board's DS3231 RTC on this stack, so the gyro MUST be on 0x69.
# Standalone BMI088 breakouts that hardwire SDO2 low can override via the
# BMI088 / BMI088Capture constructors' gyro_addr parameter.
